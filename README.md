...
- **Radial Explosion Dynamics**: Voxels blast outward in proportion to their distance from the hammer impact point.
...
- **Impact Visual Effects**: Features expanding shockwave rings, glowing spark particle bursts, and visceral camera shake on impact.
